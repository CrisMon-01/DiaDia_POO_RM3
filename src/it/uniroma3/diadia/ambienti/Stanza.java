...
public class Stanza {
	...
	public Stanza(String nome) {
		...
		this.attrezzi = new HashMap<>();// Attrezzo[NUMERO_MASSIMO_ATTREZZI];
	}
	...
	public void impostaStanzaAdiacente(String direzione, Stanza stanza) {
		if (stanza != null && direzione != null) // controllo per non inserire
													// null
	...
	public List<Stanza> getListOrdinataPerNumeroAttrezzi(){
		List<Stanza> lista = new ArrayList<>();
		Collections.sort(lista, new ComparatoreStanzePerNumeroAttrezzi());
		return lista;
	}
